package com.iquantex.shoppingcart.domain.shopping.service;
...
public class InventoryItemService {
	...
	private int getInventoryItemBalanceQtyByItemId(String itemId) {
		Future<RpcResult> rsp = phoenixClient.send(InventoryItemQueryCmd.builder().itemId(itemId).build(), null);
		try {
